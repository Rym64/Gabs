...
class SeanceController extends Controller
{
    ...
    {
        $users = Auth:: user();
        return view('teacher.abscense.createseance', compact('users','classe'))->with('Adduser', 'New seance added successfully. We sent you an email, please check your inbox.');
