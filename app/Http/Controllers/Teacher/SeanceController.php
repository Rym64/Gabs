...
class SeanceController extends Controller
{
    ...
    public function seance()
    {
        ...
        //$users->seance()->sync($request->roles);
        return view('teacher.abscense.createseance'); //, compact('users')
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('seance.create')->with('Adduser', 'New seance added successfully !!');
