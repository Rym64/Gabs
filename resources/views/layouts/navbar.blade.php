                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <a  style="color:white;" class="dropdown-item" href="{{ url('/profile') }}"
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                            <a style="color:white;"  href="{{ url('student/affiche_module') }}"class="nav-link">Liste des modules</a>
                        </li>
                        <li class="nav-item">
                            <a style="color:white;"  href="{{ url('student/affiche_module_seance') }}"class="nav-link">Liste des seances</a>
                        </li>
                        @else 
                        ...
                        <li class="nav-item">
                            <a style="color:white;"   href="{{ url('teacher/affichemodulse') }}"class="nav-link"> Seance</a>
                        </li>
                        <li class="nav-item">
                            <a style="color:white;"  href="{{ url('teacher/affectabsence') }}" class="nav-link">Show abscence</a>
                        </li>
                        <li class="nav-item">
                            <a  style="color:white;" href="{{ url('/search')}}" class="nav-link">Absence management</a>
